...
export default function CircuitMateLanding() {
  ...
  const startListening = useCallback((duration = 4200) => {
    setListening(true);

    clearInterval(tickIntervalRef.current);
    tickIntervalRef.current = setInterval(() => {
      setActiveTicks(() =>
        new Array(TICK_COUNT).fill(false).map(() => Math.random() > 0.72)
      );
    }, 160);
      ...
      <nav className="cm-nav">
        <div className="cm-nav-inner">
          ...
          <div className="cm-status-pill">
            ...
            <span className="cm-pill-text">Rime Active</span>
          </div>
        </div>
      </nav>
          ...
          <div className="cm-hero-grid">
            <div>
              ...
              <div className="cm-cta-row">
                <button className="cm-btn-primary" onClick={() => startListening(4200)}>
            ...
            <div className="cm-mic-stage">
              <div className="cm-mic-field">
                ...
                <div
                  className={`cm-mic-core${listening ? " cm-listening" : ""}`}
                  onClick={() => startListening(4200)}
                >
                  <svg viewBox="0 0 24 24" fill="none" stroke="#5eebae" strokeWidth="1.6" strokeLinecap="round">
              ...
              <div className="cm-mic-label">
                ...
                <span>{listening ? "Listening…" : "Ready to listen"}</span>
              </div>
              <div className="cm-mic-hint">Tap to preview the listening state</div>
            </div>
          </div>
        </section>
          ...
          <div className="cm-status-panel">
            <div className="cm-status-panel-left">
              ...
              <div>
                ...
                <div className="cm-status-value"><span className="cm-dot cm-pulse"></span>Rime Active</div>
              </div>
            </div>
            <div className="cm-bars" aria-hidden="true"><i></i><i></i><i></i><i></i><i></i></div>
            <div className="cm-status-sub">TTS engine ready</div>
          </div>
        </section>
      </main>
